      ...
      >
        ...
        {!isVisuallyExpanded && (
          ...
          >
            ...
            >
              <span style={{ fontSize: '10px', color: 'var(--color-obsidian)', fontWeight: '900', marginLeft: '2px' }}>▶</span>
            </div>
          </div>
        )}
        ...
        <nav className="sidebar-nav">
          ...
          <button 
            ...
            title="Settings"
          >
            <svg style={{ width: '16px', height: '16px' }} fill="none" stroke="currentColor" strokeWidth={activeTab === 'settings' ? 2.5 : 1.8} viewBox="0 0 24 24">
