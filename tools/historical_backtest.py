...
from tools.backtest.sweep import rank_cells, build_grid
...
def run_calibration(days: int = 7) -> CalibrationReport:
    ...
    from tools.backtest.calibration import load_real_trades, evaluate, match_trades
...
def run_sweep(days: int, baseline_trades: int) -> List[dict]:
    ...
    from tools.backtest.sweep import cell_metrics
