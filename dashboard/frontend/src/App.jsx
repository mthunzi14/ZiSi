...
export default function App() {
  ...
  // Unified WebSockets connection with auto-reconnection
  useEffect(() => {
    let ws;
    ...
    const connect = () => {
      ...
      // If running dev server on 3000, map to port 5000 (backend)
      ...
      ws.onclose = (e) => {
        console.log(`[WS] Connection closed (${e.code}). Reconnecting in 2s...`);
