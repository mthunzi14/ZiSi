      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: '8px' }}>
        <div>
          <h3 style={{
            ...
            {data?.isGenerating && (
              <span className="alert-pulse" style={{ fontSize: '9px', background: 'rgba(109, 129, 161, 0.15)', color: 'var(--color-accent)', padding: '2px 6px', borderRadius: '4px', border: '1px solid rgba(109, 129, 161, 0.3)' }}>
                REFRESHING...
              </span>
            )}
          </h3>
          ...
          {['win_rate', 'expectancy'].map(mode => (
            <button
              ...
              style={{
                ...
                borderRadius: '6px',
                border: 'none',
                background: colorMode === mode ? 'rgba(109, 129, 161,0.18)' : 'transparent',
